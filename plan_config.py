    ...
    "plans": [
        {
            "id": "free",
            "name": "免费版",
            "description": "体验 AI 基础能力，每天赠送积分",
            "benefits": ["每天赠送 10 积分", "可使用基础模型", "适合轻量体验"],
            "enabled": True,
            "purchasable": False,
            "amount": "0.00",
            "duration_days": 0,
        ...
        },
        {
            ...
            "benefits": ["每月赠送 500 积分", "解锁高质量对话模型", "适合日常高频使用"],
            "enabled": True,
            "purchasable": True,
            "amount": "99.00",
            "duration_days": 30,
        ...
        },
        {
            ...
            "benefits": ["每月赠送 500 积分", "季度有效期", "权益默认与月度会员一致"],
            "enabled": True,
            "purchasable": True,
            "amount": "249.00",
            "duration_days": 90,
        ...
        },
        {
            ...
            "benefits": ["每月赠送 1000 积分", "解锁全部对话模型", "可访问并发布实战区内容"],
            "enabled": True,
            "purchasable": True,
            "amount": "799.00",
            "duration_days": 365,
